...
<script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js" integrity="sha384-Q6E9RHvbIyZFJoft+2mJbHaEWldlvI9IOYy5n3zV9zzTtmI3UksdQRVvoxMfooAo" crossorigin="anonymous"></script>
  ...
  <body>
          ...
          <div class="row">
              ...
              <div class="col-md-4" style="background:cyan; height:10%;">
                  ...
                  if(isset($_SESSION['loguser']))
                      echo "<h3>Welcome &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$_SESSION['loguser']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='lout.php'>Logout</a></h3>";
                  else
      ...
      $a="insert into buy(pname,pcate,amount,username,email,phone) values('$a','$b','$c','$d','$e','$f')";
      $x=mysqli_query($con,$a);
      echo "product added";
              $i--;
              $j="update product set quantity=$i where pid=$id";
            }
          else
